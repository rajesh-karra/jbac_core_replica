...
@Component({
  selector: 'app-addattacks',
  templateUrl: './addattacks.component.html',
  styleUrls: ['./addattacks.component.css']
})
export class AddattacksComponent {
  ...
  postattacks() {
    ...
    if (this.attacksform.invalid) {
      Swal.fire('please fill the * Marked details ');
      this.showSpinner=false;
    } else {
      ...
      console.log( this.attacksform.value);
