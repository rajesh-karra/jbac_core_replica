...
@Component({
  selector: 'app-addchurchtimings',
  templateUrl: './addchurchtimings.component.html',
  styleUrls: ['./addchurchtimings.component.css']
})
export class AddchurchtimingsComponent {
  ...
  street(event: any) {
    ...
    this.getchurchstudentfilter.map((res: any) => {
      if (res.id == event.target.value) {
        console.log(res)
        this.forStreet = res.street
      }
    })
